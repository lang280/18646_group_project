...
int main()
{
    ...
    LOG_INFO("===== Deep Neural Network (C version, 256x256 input, CUDA-accelerated batch training) =====");
    LOG_INFO("1. Train (custom parameters and paths)");
    LOG_INFO("2. Inference/Test (custom model and test set paths)");
    LOG_INFO("3. Classic one-click train+inference (default paths) [Default option]");
    printf("Please select (1/2/3, press Enter for default 3): ");
